...
Junker Barlow'''],
['ALLEGIANCE', 'n', '''This thing Allegiance, as I suppose,
...
['DANGER', 'n', '''A savage beast which, when it sleeps,
...
['EXCOMMUNICATION', 'n', '''This "excommunication" is a word
...
civilization.'''],
['FORCE', 'n', '''"Force is but might," the teacher said--
...
['GORGON', 'n', '''The Gorgon was a maiden bold
...
distinction.'''],
['GRAPE', 'n', '''Hail noble fruit!--by Homer sung,
...
['GREAT', 'adj', '''"I'm great," the Lion said--"I reign
...
['IMMORTALITY', 'n', '''A toy which people cry for,
...
['INSECTIVORA', 'n', '''"See," cries the chorus of admiring preachers,
...
['KEEP', 'v.t', '''He willed away his whole estate,
...
['LAW', 'n', '''Once Law was sitting on the bench,
...
['RICHES', 'n', '''A gift from Heaven signifying, "This is my beloved son, in
...
word_dict = {w[0]: {'part': w[1], 'definition': w[2]} for w in word_list}
